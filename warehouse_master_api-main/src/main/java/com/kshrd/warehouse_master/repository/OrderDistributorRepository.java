...
public interface OrderDistributorRepository {
    ...
    @Result(property = "retailerImage", column = "retailerId", one = @One(select = "com.kshrd.warehouse_master.repository.RetailerProfileRepository.getRetailerImageById"))
    @Result(property = "storeImage", column = "storeId", one = @One(select = "com.kshrd.warehouse_master.repository.StoreRepository.getStoreImageById"))
    @Result(property = "storeName", column = "storeId", one = @One(select = "com.kshrd.warehouse_master.repository.StoreRepository.getStoreNameById"))
    @Result(property = "storeAddress", column = "storeId", one = @One(select = "com.kshrd.warehouse_master.repository.StoreRepository.getStoreAddressById"))
    @Result(property = "storePrimaryPhone", column = "storeId", one = @One(select = "com.kshrd.warehouse_master.repository.StoreRepository.getStorePrimaryPhoneById"))
    @Result(property = "storeAdditionalPhone", column = "storeId", many = @Many(select = "com.kshrd.warehouse_master.repository.StoreRepository.getAdditionalPhone"))
    @Result(property = "retailerPhone", column = "retailerId", one = @One(select = "com.kshrd.warehouse_master.repository.RetailerProfileRepository.getRetailerPhoneById"))
    @Result(property = "retailerEmail", column = "retailerId", one = @One(select = "com.kshrd.warehouse_master.repository.RetailerProfileRepository.getRetailerEmailById"))
    @Result(property = "storeEmail", column = "storeId", one = @One(select = "com.kshrd.warehouse_master.repository.StoreRepository.getStoreEmailByStoreId"))
    ...
    @Result(property = "order", column = "id",
            one = @One(select = "com.kshrd.warehouse_master.repository.OrderDistributorRepository.getOrderByOrderId"))
    @Result(property = "products", column = "id",
            many = @Many(select = "com.kshrd.warehouse_master.repository.OrderDistributorRepository.getProductOrderForOrderDetail"))
    ...
    @Result(property = "order", column = "id",
            one = @One(select = "com.kshrd.warehouse_master.repository.OrderDistributorRepository.getOrderByOrderId"))
    @Result(property = "products", column = "id",
            many = @Many(select = "com.kshrd.warehouse_master.repository.OrderDistributorRepository.getProductOrder"))
