...
//            one = @One(select = "com.kshrd.warehouse_master.repository.OrderRetailerRepository.getOrderByOrderId"))
////    @Result(property = "products", column = "id",
////            many = @Many(select = "com.kshrd.warehouse_master.repository.OrderRetailerRepository.getProductOrderByOrderIdASC",
